...
const vesselTrackerContent = () => {
    ...
    return (
        <div className="description">
            ...
            >
                <h2><span>Internal Framework</span></h2>
            </div>
            ...
            <h2 className="text">
                I maintained an internal framework still in use by 800+ HD engineers and 200+ HD designers. <br />
            </h2>
            <h2 className="text">
                I would get requests to build components from different departments (like payments or orders),
            ...
            <h2 className="text">
                ...
                after which I would present those assets to leadership.<br />
            </h2>
            <h2 className="text">
                After approval then came design, building the app in
